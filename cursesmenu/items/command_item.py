...
class CommandItem(ExternalItem):
    ...
    def __init__(self, text_color, text,  command, arguments=None, menu=None, should_exit=False):
        """
        ...
        """
        super(CommandItem, self).__init__(text_color=text_color, text=text,  menu=menu, should_exit=should_exit)
